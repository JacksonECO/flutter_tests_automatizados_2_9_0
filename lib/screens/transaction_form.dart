...
class _TransactionFormState extends State<TransactionForm> {
  ...
  Widget build(BuildContext context) {
    final TransactionWebClient webClient = AppDependencies.of(context).transactionWebClient;
    return Scaffold(
      appBar: AppBar(
  ...
  Future<Transaction> _send(TransactionWebClient webClient, Transaction transactionCreated, String password, BuildContext context) async {
    ...
    final Transaction transaction = await webClient.save(transactionCreated, password).catchError((e) {
